  ...
  return (
    <div className="rounded border shadow py-3.5 px-4 flex flex-col gap-4">
      ...
      <div className="text-sm flex flex-col md:flex-row gap-5 px-3">
        <p className="font-semibold text-gray-600 underline text-center md:text-left text-base md:text-sm">
          Bio
        </p>
        <p>{bio}</p>
      </div>
            ...
            <div className="flex gap-4 md:pl-2" key={index}>
              <div className="h-11 rounded-lg overflow-hidden border p-1 flex justify-center items-center">
                <img
                  src={
                    exp.company.logoUrl ||
                    "https://photos.wellfound.com/startups/i/267839-22e9550a168c9834c67a3e55e2577688-medium_jpg.jpg"
                  }
                  className="h-9"
                />
              </div>
      ...
      <div className="flex flex-col md:flex-row gap-3.5 justify-end">
        {isShortlisted ? (
          <>
            <button
              className="p-2 px-4 font-medium text-xs rounded-md bg-red-50 text-red-500 hover:bg-red-100 hover:text-red-700"
          ...
          <>
            ...
            <button
              className="p-2 px-4 font-medium text-xs rounded-md bg-black text-white hover:bg-gray-800"
